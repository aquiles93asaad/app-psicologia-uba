angular.module('app.FRDAO', [$cordovaSQLite])
.factory('DbAccess', function ($q) {
var DbAccess = {};
var db = $cordovaSQLite.openDatabase("my.db");

DbAccess.PopulateDB = function() {

  var createTables = "CREATE TABLE IF NOT EXISTS EVENTS (id INT NOT NULL UNIQUE, subject_id INT, color VARCHAR(30), title VARCHAR(100), description VARCHAR(500), date_start VARCHAR(50), date_end VARCHAR(50), alert_date VARCHAR(50), PRIMARY KEY(id));" +
  ...
  $cordovaSQLite.execute(db, createTables);

  var insertSubjects = "INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología General','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Estadística','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología Social','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología y Epistemología Genética','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicoanálisis, Freud','Sin Cursar','Obligatoria','Formación General','Anual',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Neurofisiología','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Historia de la Psicología','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Metodología de la Investigación','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Salud Pública y Salud Mental','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Teoría y Técnica de Grupos','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología Evolutiva: Niñez','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología Evolutiva: Adolescencia','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicopatología','Sin Cursar','Obligatoria','Formación General','Anual',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Teoría y Técnica de Exploración y Diagnóstico Psicológico. Módulo I','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Teoría y Técnica de Exploración y Diagnóstico Psicológico. Módulo II','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Inglés Módulo I','Sin Cursar','Obligatoria','Formación General','Cuatrimestral','Requisito Idioma')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Inglés Módulo II','Sin Cursar','Obligatoria','Formación General','Cuatrimestral','Requisito Idioma')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Fránces Módulo I','Sin Cursar','Obligatoria','Formación General','Cuatrimestral','Requisito Idioma')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Fránces Módulo II','Sin Cursar','Obligatoria','Formación General','Cuatrimestral','Requisito Idioma')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología, Ética y Derechos Humanos','Sin Cursar','Obligatoria','Formación Profesional','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología Institucional','Sin Cursar','Obligatoria','Formación Profesional','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología Educacional','Sin Cursar','Obligatoria','Formación Profesional','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología del Trabajo','Sin Cursar','Obligatoria','Formación Profesional','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clinica Psicológica y Psicoterapias: Clínica de Adultos','Sin Cursar','Obligatoria','Formación Profesional','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología Jurídica','Sin Cursar','Obligatoria','Formación Profesional','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica Psicológica y Psicoterapias: Psicoterapias, Emergencia e Interconsultas','Sin Cursar','Obligatoria','Formación Profesional','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicoanálisis: Escuela Inglesa','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicoanálisis: Escuela Francesa','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)   " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología Fenomenológica y Existencial','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicoanálisis: Psicología del Yo','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología de la Tercera Edad y Vejez','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicodiagnóstico: Rorschach','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Problemas Sociológicos en Psicología','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Problemas Antropológicos en Psicología','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Biología del Comportamiento','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Problemas Filosóficos en Psicología','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicoanálisis: Orientación Lacaniana. Clínica y Escritura.','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Construcción de los Conceptos Psicoanalíticos','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología Política','Sin Cursar','Optativa','Formación General','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicopedagogía Clínica','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Educacional')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Orientación Vocacional y Ocupacional','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Educacional')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Informática, Educación y Sociedad','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Educacional')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica de Niños y Adolescentes','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Fisiopatología y Enfermedades Psicosomáticas','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Neuropsicología','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Teoría y Técnica de la Clínica Sistémica','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica Psicoanalítica','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Teoría y Técnica de la Clínica Cognitivo Comportamental','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica de la discapacidad y problemas en el desarrollo infantil','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Nuevas Presencias de la Sexualidad: el Debate sobre la Construcción de la Diferencia de los Sexos','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica de las Anorexias, las Bulimias y la Obesidad. Abordaje interdisciplinario','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Criminología','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Justicia')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Intervenciones Psicológico-Forenses en Disfunciones y Patologías Familiares','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Justicia')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología del Delito y del Delincuente','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Justicia')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Técnicas Psicológicas en el Ámbito Jurídico','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Justicia')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología Preventiva','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Estrategias de Intervención Comunitaria','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Introducción a los Estudios del Género','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología Aplicada al Deporte','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('El Rol del Psicólogo en el Equipo Interdisciplinario de Salud','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicopatología Infanto Juvenil','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Análisis y Modificación de la Conducta','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral',NULL)  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología de la Discapacidad','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Educacional')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicofarmacología','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Diagnóstico y Abordaje de las Crisis Infanto Juveniles','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Metodología Psicoanalítica Cát. II','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica Psicoanalítica Cát. II','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica de las Toxicomanías y el Alcoholismo','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Usos del Síntoma','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica del Autismo y la Psicosis en la Infancia','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Selección e Incorporación de Personal','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Trabajo')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicologia aplicada a las organizaciones','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Trabajo')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Niños y Adolescentes en Conflicto con la Ley Penal: Abordaje Integral','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Justicia')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Victimología','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Justicia')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Criminología','Sin Cursar','Optativa','Formación Profesional','Cuatrimestral','Área Justicia')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica de la Urgencia','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Orientación Psicosomática. Hospital Durand.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('La Clínica en la Emergencia','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica en Salud Mental en Hospital J. T. Borda','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Variantes en la Consulta Ambulatoria','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica de Niños y Adolescentes: las Formaciones del Síntoma.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Hospital de Niños Dr. R. Gutiérrez','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica de las Adicciones: Abordaje Interdisciplinario.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica con Púberes y Adolescentes en el Hospital','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Hospital de Día y Problemáticas Clínicas Contemporáneas','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Práctica Clínica Psicoanalítica de Niños con Base Comunitaria','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Fundamentos Clínicos del Acompañamiento Terapéutico.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Atención Psicológica en un Hospital','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicoprofilaxis Quirúrgica. Intervención Psicológica ante Enfermedades de Resolución Quirúrgica.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('El Sujeto en la Clínica. Vicisitudes y Obstáculos.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Neuropsicología Práctica: Técnicas de Evaluación.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología Perinatal','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('El Juego en los Límites: el Psicoanálisis y la Clínica en Problemas en el Desarrollo Infantil.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Problemática Clínica en Niñez , Adolescencia y Familia','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Práctica Clínica en Anorexias, Bulimias y Obesidad','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Cuestiones Clínicas en los Inicios de la Práctica Psicoanalítica','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Una Perspectiva Antropológica en la Clínica','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Dispositivos de intervención en consumos nocivos y prácticas adictivas','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Clínica en las Instituciones Públicas. Dispositivos de Salud Mental en el Abordaje de la Complejidad','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Abordaje de las Patologías del Acto: la Clínica en los Bordes','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('El Tratamiento el Padecimiento Subjetivo en la Experiencia Analítica','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('El Rol del Psicólogo en el Ámbito de las Tecnologías de Reproducción Humana Asistida','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Orientación Vocacional y Ocupacional (Práctica Profesional)','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Educacional')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Discapacidad: Intervenciones en la Niñez y la Adolescencia. El Proceso de Integración.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Educacional')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Proceso de Reinserción Laboral','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Trabajo')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Inserción Laboral de Jóvenes Socialmente Vulnerables','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Trabajo')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Factores Psicosociales Vinculados a la Psicodinámica del Trabajo','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Trabajo')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Instituciones Forenses','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Justicia')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('El Trabajo con Familias en el Ámbito Jurídico','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Justicia')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('La Actividad Pericial en Psicología Jurídica','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Justicia')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('La Ejecución de la Pena. Trabajo Interdisciplinario en el Seguimiento de los Condenados.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Justicia')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Ámbito Comunitario: Familia y Enfermedad Crónica.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('El Psicólogo en el Ámbito Comunitario','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Salud Mental y Desinstitucionalización','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('El Rol del Psicólogo en una Experiencia de Trabajo Interdisciplinario en la Comunidad','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Adicciones. Un abordaje Clínico - Comunitario.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('El Psicólogo en Centros de Atención Primaria. Un Enfoque Preventivo y Comunitario del Trabajo en Salud.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Promoción de la Salud en Adolescentes. Prácticas en Evaluación, Diagnóstico y Prevención en Instituciones Educativas.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Violencia. Modos de Intervención en los Dispositivos Clinicos y Socio Comunitarios.','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología del Deporte y Actividad Física','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('El Rol del Psicólogo/a en la Promoción de la Salud Sexual y la Salud Reproductiva','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Intervenciones Psicoanalíticas con Jóvenes en Situación de Vulnerabilidad','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Social - Comunitaria')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('La Angustia en la Experiencia Analítica','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('La Clínica Psicoanalítica en Dispositivos Institucionales','Sin Cursar','Práctica Profesional','Formación Profesional','Cuatrimestral','Área Clínica')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('La Psicología en el Ámbito Jurídico. Reflexiones Ético-clínicas a través de un Estudio Cualitativo de Casos.','Sin Cursar','Práctica Investigación','Formación Profesional','Cuatrimestral','Área Investigación')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Métodos Psicofisiológicos','Sin Cursar','Práctica Investigación','Formación Profesional','Cuatrimestral','Área Investigación')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Psicología y Educación: los Psicólogos y su Participación en Comunidades de Práctica de Aprendizaje Situado','Sin Cursar','Práctica Investigación','Formación Profesional','Cuatrimestral','Área Investigación')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Aportes del Psicoanálisis a la Clínica de las Afecciones Psicosomáticas. Dirección de la Cura y Coordenadas Subjetivas del Desencadenamiento.','Sin Cursar','Práctica Investigación','Formación Profesional','Cuatrimestral','Área Investigación')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Salud Mental y Atención Primaria de la Salud: Investigaciones desde la perspectiva de Derechos.','Sin Cursar','Práctica Investigación','Formación Profesional','Cuatrimestral','Área Investigación')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Evaluación Psicológica en Contexto.','Sin Cursar','Práctica Investigación','Formación Profesional','Cuatrimestral','Área Investigación')  " +
"INSERT INTO  SUBJECTS (name,state,type,formation,duration,area) VALUES('Cine y Subjetividad: el Método de Lectura Ético-Analítica de Películas y Series Televisivas.','Sin Cursar','Práctica Investigación','Formación Profesional','Cuatrimestral','Área Investigación')";

  $cordovaSQLite.execute(db, insertSubjects);

  var insertClasses = "INSERT INTO CLASSES (name,num_cat,subject_id) SELECT 'Prof. Tit. Reg. G. González','044',id FROM SUBJECTS WHERE NAME='Psicología General'  " +
...
"INSERT INTO PRED_SUC_CORRELATIVES (id_pred,id_suc) VALUES (15,24)";
  $cordovaSQLite.execute(db, insertCorrelatives);
