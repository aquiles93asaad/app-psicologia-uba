...
function populateDbService($q, $cordovaSQLite, dbName) {
    ...
    function createTables(dataBase) {
        ...
        var query = "DROP TABLE IF EXISTS EVENTS;" +
        "DROP TABLE IF EXISTS subjects;" +
        "DROP TABLE IF EXISTS CLASSES;" +
        "DROP TABLE IF EXISTS PRED_SUC_CORRELATIVES;" +
        "DROP TABLE IF EXISTS NOTES;" +
        "DROP TABLE IF EXISTS CONFIGS;" +
        "CREATE TABLE EVENTS (id INTEGER PRIMARY KEY AUTOINCREMENT, subject_id INT, color TEXT, title TEXT, description TEXT, date_start TEXT, date_end TEXT, alert_date TEXT, FOREIGN KEY (subject_id) REFERENCES subjects(id)); " +
        ...
        "INSERT INTO subjects (name,state,type,formation,duration,area) VALUES('Psicología General','Sin Cursar','Obligatoria','Formación General','Cuatrimestral',NULL);" +
    ...
    function insertClasses() {
        ...
        query = "SELECT * from BDpsicologiaUba.subjects";
        return executeTransaction(deferred, query);
    }
    ...
    function insertCorrelatives() {
        ...
        var query = "INSERT INTO PRED_SUC_CORRELATIVES (id_pred,id_suc) VALUES (NULL,1) ;" +
